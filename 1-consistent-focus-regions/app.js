require(["esri/core/reactiveUtils"], (reactiveUtils) => {
  ...
  const contextSpanEl = document.getElementById("context-span");
  ...
  function handleModeChange() {
    ...
    toggleModeEl.text = isDarkMode ? "Toggle dark mode off" : "Toggle dark mode on";
    contextSpanEl.innerText = isDarkMode ? "Dark mode activated" : "Light mode activated";
  ...
  effectBlockSectionEl.addEventListener("calciteBlockSectionToggle", (evt) => {
    if (evt.target.open) {
      ...
      updateBloom(bloomIntensity, bloomRadius, bloomThreshold);
      contextSpanEl.innerText = "Bloom effect applied";
    } else {
      updateBloom(0, 0, 0);
      contextSpanEl.innerText = "Bloom effect removed";
    }
  });
  ...
  shadowBlockSectionEl.addEventListener("calciteBlockSectionToggle", (evt) => {
    if (evt.target.open) {
      ...
      contextSpanEl.innerText = "Drop shadow effect applied"
    } else {
      updateShadow(0, 0, 0);
      contextSpanEl.innerText = "Drop shadow effect removed";
    }
  });
